...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('stories', function (Blueprint $table) {
            ...
            $table->string('disciplinary_action')->nullable()->default(null)->comment('censored/etc');
    ...
    public function down()
    {
        Schema::table('stories', function (Blueprint $table) {
            ...
            $table->dropColumn(['disciplinary_action', 'disciplinary_action_taken_at','disciplinary_action_taken_by']);
        });
    }
};
